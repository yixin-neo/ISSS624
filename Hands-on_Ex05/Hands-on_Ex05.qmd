...
First, set the cluster groups as matrix to get it ready to be appended to shan_sf_cluster (from shan_sf + hierarchical clustering results) to get another data frame called shan_sf_spatialcluster
...
Append it to the shan_sf_cluster sf data frame
