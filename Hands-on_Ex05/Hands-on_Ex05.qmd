...
1.  clust6\$groups shows us the cluster number each polygon is assigned to.
...
### 5.9.1 A short note about ClustGeo package (only Ward method for hierachical clsutering,  can use any distance method or proximity matrix)
