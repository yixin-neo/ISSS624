...
5.3. Spatial Window AVERAGE (create neighbour structure with diagonals , standardize rows with equal weight)
...
5.4. Spatial Weights SUM (without row standardized weights, assign binary weights to neighbour structure with diagonal element)
